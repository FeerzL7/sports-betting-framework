...
LEAGUE_TO_ODDS_API = {
    # Soccer
    "PL": "soccer_england_bremier_league",
...
class OddsAPIProvider(OddsProviderBase):
    ...
    tomamos la odds máxima disponible (mejor valor para el bettore).
    ...
    def _normalize_single_game(self, game: Dict, sport: Sport) -> Optional[OddsData]:
        ...
        return OddsData(
            ...
            spread_line=None,           # TODO: implementar spread cuando lo agreguen
